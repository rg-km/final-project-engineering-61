...
class Update extends React.Component {
  constructor(props) {
    super(props);
    const { id,nama, bab1, materi1, bab2, materi2,bab3, materi3,bab4, materi4,bab5, materi5,bab6, materi6,bab7, materi7,bab8, materi8,bab9, materi9,bab10, materi10 } = props.location.state.contact;
    this.state = {
      id,nama, bab1, materi1, bab2, materi2,bab3, materi3,bab4, materi4,bab5, materi5,bab6, materi6,bab7, materi7,bab8, materi8,bab9, materi9,bab10, materi10,
    };
  }
  ...
  update = (e) => {
    ...
    this.props.updateMateriHandler(this.state);
